...
PDS::Config - Site-independent configuration file for the Versatile Web Framework
...
Creates a new PDS::Config instance with hierarchical configuration loading.
...
B<Returns:> Blessed PDS::Config object
